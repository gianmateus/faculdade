...
// Você utilizará seus conhecimentos de vetores (arrays unidimensionais) em C para representar um 
// tabuleiro simplificado e posicionar dois navios nele: um na vertical e outro na horizontal. 
// Continue o desenvolvimento no mesmo programa iniciado anteriormente.
...
// Você deverá escolher as coordenadas iniciais de cada navio e garantir 
// que eles estejam completamente dentro dos limites do tabuleiro e não se sobreponham. 
// Dica: O posicionamento do navio pode ser feito copiando o valor 3 de cada posição do vetor do 
// navio para as posições correspondentes na matriz do tabuleiro, de acordo com a orientação (horizontal ou vertical) do navio.
...
// Legibilidade: O código deve ser escrito de forma clara, organizada e fácil de entender, 
// com nomes de variáveis descritivos e indentação consistente.
